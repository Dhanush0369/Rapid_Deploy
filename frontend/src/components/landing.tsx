...
console.log("Backend URL:", BACKEND_UPLOAD_URL);
          ...
          <div className="space-y-4">
            ...
            <Button onClick={async () => {
              ...
              console.log(response.data.response);
                if (response.data.response === "Deployed") {
                  console.log("Status is Deployed, about to set state to true");
                  clearInterval(interval);
                  setDeployed(true);
                  console.log("Deployed state set to true");
                }
              }, 3000)
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.rapid_deploy.com:3001/index.html`} />
          </div>
          <br />
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.rapid_deploy.com:3001/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
